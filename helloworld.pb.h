...
// int64 key = 2;
inline void HelloRequest::clear_key() {
  key_ = PROTOBUF_LONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::int64 HelloRequest::key() const {
  // @@protoc_insertion_point(field_get:helloworld.HelloRequest.key)
  return key_;
}
inline void HelloRequest::set_key(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  key_ = value;
  // @@protoc_insertion_point(field_set:helloworld.HelloRequest.key)
}
...
// int64 value = 2;
inline void HelloReply::clear_value() {
  value_ = PROTOBUF_LONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::int64 HelloReply::value() const {
  // @@protoc_insertion_point(field_get:helloworld.HelloReply.value)
  return value_;
}
inline void HelloReply::set_value(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  value_ = value;
  // @@protoc_insertion_point(field_set:helloworld.HelloReply.value)
}
