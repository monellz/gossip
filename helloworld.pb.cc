...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_helloworld_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::helloworld::HelloRequest, key_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::helloworld::HelloReply, value_),
};
...
const char descriptor_table_protodef_helloworld_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "loReply\022\017\n\007message\030\001 \001(\t\022\r\n\005value\030\002 \001(\0032"
  "I\n\007Greeter\022>\n\010SayHello\022\030.helloworld.Hell"
  "oRequest\032\026.helloworld.HelloReply\"\000b\006prot"
  "o3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_helloworld_2eproto = {
  &descriptor_table_helloworld_2eproto_initialized, descriptor_table_protodef_helloworld_2eproto, "helloworld.proto", 202,
...
const int HelloRequest::kKeyFieldNumber;
...
void HelloRequest::SerializeWithCachedSizes(
  ...
  // int64 key = 2;
  if (this->key() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64(2, this->key(), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* HelloRequest::InternalSerializeWithCachedSizesToArray(
  ...
  // int64 key = 2;
  if (this->key() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(2, this->key(), target);
  }
...
const int HelloReply::kValueFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
